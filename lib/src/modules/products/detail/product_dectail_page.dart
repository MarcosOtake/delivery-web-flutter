...
import '../../../core/ui/helpers/mensagens.dart';
import '../../../core/ui/helpers/size_extensions.dart';
import '../../../core/ui/helpers/upload_html_helper.dart';
import '../../../core/ui/styles/text_styles.dart';
import 'product_dectail_controller.dart';

class ProductDectailPage extends StatefulWidget {
  final int? productId;

  const ProductDectailPage({super.key, required this.productId});

  @override
  State<ProductDectailPage> createState() => _ProductDectailPageState();
}

class _ProductDectailPageState extends State<ProductDectailPage>
    with Loader, Messages {
  final controller = Modular.get<ProductDectailController>();
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      reaction((_) => controller.status, (status) {
        switch (status) {
          case ProductDectailStateStatus.initial:
            break;
          case ProductDectailStateStatus.loading:
            showLoader();
            break;
          case ProductDectailStateStatus.loaded:
            ...
            hideLoader();
            break;
          case ProductDectailStateStatus.error:
            hideLoader();
            showError(controller.errorMessage!);
            break;
          case ProductDectailStateStatus.errorLoadProduct:
            hideLoader();
            showError("Erro ao carregar o produto para alteração");
            Navigator.of(context).pop();
            break;
          case ProductDectailStateStatus.uploaded:
            hideLoader();
            break;
          case ProductDectailStateStatus.deleted:
          case ProductDectailStateStatus.saved:
            hideLoader();
